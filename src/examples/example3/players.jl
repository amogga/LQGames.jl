...
const car1 = let
    costinfo = CostInfoT1([6,35],0,12,8,4,[[6.0,-100.0],[6.0,100.0]],3)
    state_weight = StateCostWeightT1(4,50,50,100,100,0,100)
    input_weight = InputCostWeightT1(25,10)
...
const car2 = let
    costinfo = CostInfoT1([12,12],0,10,5,4,[[2.0,100.0],[2.0,18.0],[2.5,15.0],[3.0,14.0],[5.0,12.5],[8.0,12.0],[100.0,12.0]],3)
    state_weight = StateCostWeightT1(1,50,50,100,100,0,100)
    input_weight = InputCostWeightT1(25,10)
...
const bicycle = let
    costinfo = CostInfoT2([15,21],0,5,4,1)
    state_weight = StateCostWeightT2(5,100,100,0,100)
    input_weight = InputCostWeightT2(30,20)
